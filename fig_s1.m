...
%% fig S1-C, the association between the coupling and diease condition
...
%% fig S1-D, the association between the coupling and apoe
subplot(122),
...
dc=pd_beh_tmp2(:,4);
cp=pd_beh_tmp2(:,1);
%% fig S1-A, the association between the coupling and age
...
%% fig S1-B, the association between the coupling and gender
