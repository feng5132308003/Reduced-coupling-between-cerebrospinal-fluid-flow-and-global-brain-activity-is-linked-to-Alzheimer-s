%% figure S8-upper row, test the main results on the ADNI2 data
clear
...
cp=pd_beh_tmp2(adni_2,end);
dc=pd_beh_tmp2(adni_2,1);
suvr=pd_beh_tmp2(adni_2,2);
suvr_l=pd_beh_tmp2(adni_2,3);
mmse=pd_beh_tmp2(adni_2,4);
mmse_l=pd_beh_tmp2(adni_2,5);
...
%% figS8-A, the association between the coupling and SUVR
...
%% figS8-B, the association between the coupling and 2-year changes of SUVR
suvr=suvr_l;
tbl = table(cp,test_id2,age2,gender2, ...
    'VariableNames',{'cp','test_id2','age2','gender2'});
...
%% figS8-C, the association between the coupling and MMSE
suvr=mmse;
tbl = table(cp,test_id2,age2,gender2, ...
    'VariableNames',{'cp','test_id2','age2','gender2'});
...
%% figS8-D, the association between the coupling and 2-year changes of MMSE
suvr=mmse_l;
tbl = table(cp,test_id2,age2,gender2, ...
    'VariableNames',{'cp','test_id2','age2','gender2'});
