...
for li=1:length(test_overlap)
    subj_list_all_159{li}=test_overlap{li}(1:4);
end
...
[h,p1,stats] = fishertest([0 7; 33 27]','Alpha',0.05)

[h,p2,stats] = fishertest([0 7; 13 5]', 'Alpha',0.05)

[h,p3,stats] = fishertest([0 7; 19 9]','Alpha',0.05)

[h,p4,stats] = fishertest([33 27; 13 5]','Alpha',0.05)

[h,p5,stats] = fishertest([33 27; 19 9]','Alpha',0.05)

[h,p6,stats] = fishertest([13 5; 19 9]','Alpha',0.05)
[p1 p2 p3 p4 p5 p6]